...
board.show()
print(board.add_play({'g10' : 'd', 'i10' : 'v', 'j10' : 'i', 'k10' : 'e', 'l10' : 'r'}, False))
board.show()
...
board.show()
print(board.add_play({'k5' : 'a', 'k6' : 's', 'k7' : 'e', 'k8' : 's', 'k9' : 'i', 'k10' : 'n', 'k11' : 'a'}))
board.show()
print(board.add_play({'j2' : 'a', 'j3' : 's', 'j4' : 'a', 'j5' : 'c', 'j7' : 'd', 'j8' : 'o', 'j9' : 's'}))
board.show()